...
const DEFAULT_HOST = "go.srg.id.au";
const DEFAULT_BASE = "https://go.srg.id.au/";
...
div.container { background-color: #FFF; margin:20px; padding: 20px; max-width: 700px; border-radius: 10px; border: 2px solid coral; box-shadow: 10px 10px; }
...
const htmlend = `
<footer><hr>
<subtitle style="font-size:0.8rem;color:darkgray">created by srg. <a href="${DEFAULT_BASE}">Home</a> | <a href="javascript:document.location.href='${DEFAULT_BASE}n?url='+encodeURIComponent(document.location.href)" onclick="alert('Drag this to your bookmarks bar.');return false;">Bookmarklet</a> | <a href="https://replit.com/@gad0003/url-shortener">Source code</a>
</subtitle></footer>
</div>
</body>
`
...
app.get("/", async (req, res) => {
  ...
  res.end(`
      ${htmlhead}
      <div>
      <b class="indextitle">URL shortner running at ${req.get("host")}</b><br/>
      ...
      <form action="n" method="GET" autocomplete="off">
        ...
        <label>Password<br/><input type="password" name="password" autocomplete="false"></label><br/>
...
app.get("/n", async (req, res) => {
  ...
  if (req.query.json) {
    ...
    return res.redirect(301, base + newId + "/stats?new=true&password=" + req.query.password)
  }
